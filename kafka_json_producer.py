...
FILE_PATH = "C:\\Users\\ssmelmuri\\OneDrive - IQVIA\\Documents_bkp\\Big Data\\Kafka Demo\\cardekho_dataset.csv"
columns=['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
       'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
       'seats', 'selling_price']

API_KEY = 'TEDALC3KS4KNOCIN'
ENDPOINT_SCHEMA_URL  = 'https://psrc-vrpp5.us-east-2.aws.confluent.cloud'
API_SECRET_KEY = 'NWfleWSO/KOwtSQStCsQ9ScTcou6ZvGv1UsjZQqhIJwz6kHU/9g7cYKNfxZOnwwt'
BOOTSTRAP_SERVER = 'pkc-921jm.us-east-2.aws.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'I7MHLGXJPZZD3BAF'
SCHEMA_REGISTRY_API_SECRET = 'vpqTQqtIksBT8iZgu20lXn4Tci3qp07WEsXxeRxyC5i1HUrMyBnIgG//DbGvZ9/M'
